                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a class="page-scroll" href="#blog">وبلاگ</a>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="#portfolio">نمونه کارها</a>
                                    </li>
                                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">رویدادها<span class="caret"></span></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#" >رویدادهای پیش رو</a></li>
                                            <li><a href="#" >رویدادهای گذشته</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="page-scroll" href="#team">گروه ما</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1"><b>ایده ها را پرورش می دهیم</b></h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">با ما تجارت خود را به اوج برسانید</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">خدمات ما</a>
                                    <a class="ready-btn page-scroll" href="#about">بیشتر بدانید</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content text-center">
                                ...
                                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">چتر حمایتی برای شما ایجاد می کنیم </h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">امنیت شغلی داشته باشید و آرامش را تجربه کنید</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">خدمات ما</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                <!-- layer 1 -->
                                <div class="layer-1-1 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <h2 class="title1">شما را در قالب تیمی منسجم آماده می کنیم</h2>
                                </div>
                                <!-- layer 2 -->
                                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                    <h1 class="title2">برای پیاده سازی هر ایده ای تیمی متشکل از افراد متخصص ایجاد می کنیم</h1>
                                </div>
                                <!-- layer 3 -->
                                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                    <a class="ready-btn right-btn page-scroll" href="#services">خدمات ما</a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="well-middle">
                        <div class="single-well">
                            <a href="#">
                                <h4 class="sec-head">ایده اصلی ما</h4>
                            </a>
                            <p>
